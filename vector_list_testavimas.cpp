...
void testuoti_konteinerius(int skaiciavimo_metodas) {
    ...
    if (konteinerio_pasirinkimas == "vector") {
        testuoti<vector<Studentas>>(failai, irasai, skaiciavimo_metodas, "vector");
    } else if (konteinerio_pasirinkimas == "list") {
        testuoti<list<Studentas>>(failai, irasai, skaiciavimo_metodas, "list");
